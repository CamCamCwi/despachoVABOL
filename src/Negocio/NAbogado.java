...
public class NAbogado {
    ...
    public NAbogado(int abg_ci, String abg_nombre, String abg_apellidop, String abg_apellidom, String abg_especialidad, int abg_celular, String abg_fnacimiento, String abg_genero, int abg_nrocolabogados, int abg_nrominjusticia, int abg_numregcorte, int fk_abg_usuario, String mail, String contraseña) {
    ...
    private String ValidarDatos() {
        ...
        res += (dato.getfNacimiento().length() < 10) ? "Fecha de nacimiento del Abogado Debe ser formato DD-MM-AAAA," : "";
    ...
    public String RegistrarAbogado() {
        String res = ValidarDatos();
        if (res.length() == 1) {
//            user.setContraseña(HASH(user.getContraseña()));
            return dato.Registrar()&&user.registrar()?"Abogado Registrado con exito":"Fallo al Registrar el Abogado";
        }
        return res;
    }

    public String ModificaAbogado() {
        String res = ValidarDatos();
        if (res.length() == 1) {
    ...
    public static String ModificarContraseñaAbogado(String mail, String anterior_contraseña, String nueva_contraseña) {
